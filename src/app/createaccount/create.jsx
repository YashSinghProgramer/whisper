...
function Login() {
	...
	// Avatar select karne par index aur image dono ek sath handle karne ke liye function
			...
			<div
				...
				<div className="h-[70px] w-3/4 border-2 border-green-700 rounded-3xl flex items-center gap-4 bg-white/10 mb-10 p-2 ">
					<img
						...
						alt="Profile Preview"
					/>
					{/* Fallback check: Username khali hone par default text placeholder dikhega */}
				...
				<form
					...
					{/* Username Input (Corrected standard handling) */}
					<input
					...
					{/* Dynamic Avatar Array Selection */}
